...
zh_cn_desc = {
    ...
    'tech.html': '技术是为了交付。GitHub项目展示：Web应用、跨平台开发、自动化系统、CI/CD流程与AI工程——想得到，做得出的技术能力。',    'invest.html': '买公司不是买彩票。巴菲特式价值投资框架：企业价值分析、安全边际、概率思维、经济学视角与AI辅助研究，帮你做出更理性的投资决策。',
    ...
    'human-in-the-loop.html': 'Feng人机合作自动化范式：五层x双轨x双循环x三横梁——一套覆盖内容制造的完整方法与软件工程架构。含极简问答与框架图。'
}
...
zh_hk_desc = {
    ...
    'tech.html': '技術是為了交付。GitHub項目展示：Web應用、跨平台開發、自動化系統、CI/CD流程與AI工程——想得到，做得出的技術能力。',
    ...
    'human-in-the-loop.html': 'Feng人機合作自動化範式：五層x雙軌x雙循環x三橫樑——一套覆蓋內容製造的完整方法與軟件工程架構。含極簡問答與框架圖。'
}
