(function () {
  ...
  var copy = {
    en: {
      ...
      systemHref: '/en/system.html',
      systemGraph: 'Relation Graph',
      systemGraphHref: '/en/system-graph.html',
      systemProjects: 'Project Inventory',
      systemProjectsHref: '/en/system-projects.html',
      ...
      ethosPart7: 'Unfit',
      blogHref: '/en/blog/',
      pd5: 'Feng Human-in-the-Loop',
      pd5Href: '/en/human-in-the-loop.html',
      web3: 'Web3',
      ...
      flygo: 'FlyGo',
      flygoHref: '/en/flygo.html',
      siteTracks: 'Explore the site by track',
    ...
    'zh-cn': {
      ...
      system: '体系全景',
      systemHref: '/zh-cn/system.html',
      systemGraph: '关系图',
      systemGraphHref: '/zh-cn/system-graph.html',
      systemProjects: '项目全清单',
      systemProjectsHref: '/zh-cn/system-projects.html',
      investment: '\u6295\u8d44',
      ...
      blogHref: '/zh-cn/blog/',
      pd5: 'Feng Human-in-the-Loop',
      pd5Href: '/zh-cn/human-in-the-loop.html',
      web3: 'Web3',
    ...
    'zh-hk': {
      ...
      system: '體系全景',
      systemHref: '/zh-hk/system.html',
      systemGraph: '關係圖',
      systemGraphHref: '/zh-hk/system-graph.html',
      systemProjects: '項目全清單',
      systemProjectsHref: '/zh-hk/system-projects.html',
      investment: '\u6295\u8cc7',
      ...
      blogHref: '/zh-hk/blog/',
      pd5: 'Feng Human-in-the-Loop',
      pd5Href: '/zh-hk/human-in-the-loop.html',
      web3: 'Web3',
...
var labels = copy[lang];
  ...
  var style = document.createElement('style');
    ...
    style.textContent = [
      ...
      /* ---- Submenu group label ---- */
      '.shared-subpage-nav .desktop-menu .submenu li.nav-group, #submenu-portal .sp-wrap li.nav-group { padding: 8px 18px 2px; font-size: 10px; font-weight: 600; letter-spacing: 0.06em; text-transform: uppercase; color: #6e6e73; white-space: nowrap; border-bottom: 0; }',
      ...
      '.shared-subpage-nav .mobile-submenu li.nav-group, #mobile-panel-portal .mobile-submenu li.nav-group { padding: 10px 12px 2px; font-size: 11px; font-weight: 600; letter-spacing: 0.06em; text-transform: uppercase; color: #6e6e73; }',
  ...
  container.outerHTML = [
    ...
    '            <li><a href="' + labels.homeHref + '#tracks">' + labels.siteTracks + '</a></li>',
    '          </ul>',
    '        </li>',
    ...
    '            <li><a href="' + labels.systemHref + '">' + labels.system + '</a></li>',
    '            <li><a href="' + labels.systemGraphHref + '">' + labels.systemGraph + '</a></li>',
    '            <li><a href="' + labels.systemProjectsHref + '">' + labels.systemProjects + '</a></li>',
    '            <li class="nav-group">' + labels.software + '</li>',
	    ...
	    '            <li><a href="' + labels.flygoHref + '">' + labels.flygo + '</a></li>',
    ...
    '    <button class="menu-toggle" type="button" aria-expanded="false" aria-label="' + labels.menuToggle + '">',
