...
The first principle of creating value is solving problems, not providing labour.
...
The first principle of fast iteration is validating the model, not shipping for its own sake.
The first principle of validating the model is systemising it, not grinding alone.
The first principle of systemising is leverage, not linear accumulation.
