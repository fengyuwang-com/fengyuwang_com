...
Sales is not a profession; it's a patch from a particular historical era — a temporary patch for opaque organizations, opaque markets, users who don't understand their tools. Two forces are now peeling it off: software is devouring the software companies' sales teams, and AI is devouring the rest.

Judge any company by one indicator: count its salespeople and you've counted its information-flow diseases. As for salespeople themselves — no hatred necessary. The least trusted job is also the first to be replaced by pipes; sellers and buyers are trapped in the same clogged market. The end state of a product is zero salespeople: not because the people vanished, but because the product finally speaks for itself.
